...
/* Assume a symmetric Diffoperator instead of a triangular one */
//#define SYM_DIFFOP
...
#define INPUT_SIZE 1024
  ...
  extern void get_fields_no(double **series,struct param p,struct sfound sf,
			    ...
			    double **x);
  extern void get_fields_no_circ(double **series,struct param p,struct sfound sf,
				 double *drift,double **gamma,double **dif,
				 double **x);
  extern void make_cast_no(double **x,double *new,struct param p,double *drift,
			   double **gamma,double **dif);
  extern void make_cast_no_circ(double **x,double *new,struct param p,double *drift,
				double **gamma,double **dif);
  ...
  extern void init_neighbor_search(double **x,struct param p,
				   unsigned int *fut);
  extern void put_in_boxes_circ(int which,double **x,struct param p,
				unsigned int *fut);
  extern void init_neighbor_search_circ(double **x,struct param p,
					unsigned int *fut);
  ...
  extern void search_neighbors(double **x,double **y,struct param p,
				 struct sfound sf);
  extern unsigned int find_neighbors_circ(double **x,double **y,unsigned int box,
					  struct param p,struct sfound sf,
					  double eps);
  extern void search_neighbors_circ(double **x,double **y,struct param p,
				    struct sfound sf);
  ...
  extern void get_diffusion(double **mat,struct param p);
  ...
  extern void make_ar_cast(double **x,double *new,struct param p,double *coeff0,
